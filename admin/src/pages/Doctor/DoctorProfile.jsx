...
const DoctorProfile = () => {
  ...
  const updateProfile = async () => {
    ...
    try {
      //We are getting the data from profileData and storing it in updateData to send it to Database using backend
      const updateData = {
          ...
          <div className="flex-1 border border-stone-200 rounded-lg p-8 py-7 bg-white">
            ...
            {isEdit ? (
              ...
              <button
                ...
                className="px-4 py-1 border border-primary text-sm rounded-full mt-5 hover:bg-primary hover:text-white transition-all cursor-pointer">Edit</button>
            )}
          </div>
        </div>
      </div>
