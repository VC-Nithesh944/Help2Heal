...
const Appointment = () => {
  //To navigate to Login page if not Login in to book appointment
  ...
  const getAvailableSlots = async () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      currentDate.setDate(today.getDate() + i); //to get future seven days to display on website

      //setting end time of the date with index
      let endTime = new Date();
      endTime.setDate(today.getDate() + i);
      endTime.setHours(21, 0, 0, 0); //Hours = 21, min = 0, sec= 0 , milliseconds = 0

      //setting hours
      if (today.getDate() === currentDate.getDate()) {
        //if current time is 11am then we should start directly with 12 pm displayed on website
      ...
      while (currentDate < endTime) {
        //To create the button slots for Time
        //For am pm
        ...
        //to check whether slot is booked or not
